export function buildPlayerHTML(contentConfig) {
  ...
  return `
    <div id="player-wrapper">
      ...
      <div id="vertical-menu-container" class="vertical-menu-container">
        <div class="vertical-language-server-controls">
          ...
          <div id="open-quality-modal-btn-vertical" class="select-wrapper select-with-icon control-group hidden">
            <span class="material-icons">high_quality</span>
            <span class="quality-select-text">Calidad</span>
            <span class="material-icons dropdown-arrow">arrow_drop_down</span>
          </div>
        </div>
    ...
    contentConfig.prevChapterUrl
          ...
          <div id="open-quality-modal-btn" class="select-wrapper select-with-icon control-group hidden">
            <span class="material-icons">high_quality</span>
            <span class="quality-select-text">Calidad</span>
            <span class="material-icons dropdown-arrow">arrow_drop_down</span>
          </div>
      ...
      <div id="quality-selection-modal" class="popup hidden">
        <div class="popup-header">
          <h3>Seleccionar Calidad</h3>
        </div>
        <div class="popup-content quality-selection-content">
          <div id="quality-buttons-container" class="quality-buttons-container">
            <!-- Quality buttons will be inserted here dynamically -->
          </div>
        </div>
        <div class="modal-buttons">
          <button id="quality-cancel-btn" class="btn-secondary">Cancelar</button>
        </div>
      </div>
