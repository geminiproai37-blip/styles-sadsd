// DOM Elements
        ...
        const generateFinalHTML = (mediaId, season, episode, episodesJson, theme, categories, tmdbLogoLang) => {
            const indexHtmlContent = `<!DOCTYPE html>
<html lang="es">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Yami Lat - Tu Guía de anime-seccion</title>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/anime-seccion/style.css" />
  </head>
  ...
  <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/anime-seccion/main.js"><\\/script>
  <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/anime-seccion/lazy-loader.js"><\\/script>
  <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/anime-seccion/script.js"><\\/script>
</body>
</html>`;
  ...
  <script type="module">
    ...
    document.close();
        ...
        const handleGenerate = () => {
            ...
            const finalHTML = generateFinalHTML(mediaId, season, episode, episodesJson, theme, categories, tmdbLogoLang);
