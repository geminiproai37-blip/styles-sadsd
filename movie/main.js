...
import { fetchMediaDetails, categoriesParam } from "./script.js"; // Import categoriesParam
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  appRoot.appendChild(buildMainContent(categoriesParam)); // Pass categoriesParam to buildMainContent
