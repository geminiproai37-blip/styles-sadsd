import { fetchMediaDetails, fetchCast, fetchMovieVideos, fetchAnimeGenres, categoriesParam } from "./script.js";
...
export async function buildMovieDetailPage(
  ...
  // Add categories from categoriesParam
  ...
  categories.forEach(category => {
    ...
    categorySpan.textContent = category.replace(/_/g, ' ').replace(/\b\w/g, char => char.toUpperCase());
