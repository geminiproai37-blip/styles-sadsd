...
<html lang="es">
  <head>
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/css/styles.css" as="style" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/css/styles.css" media="all" />
    <link
  ...
  <body class="bg-gray-900 text-white">
    ...
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/script.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/home.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/series.js" defer></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/adultContent.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/configuracion.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/aboutAndDMCA.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/buscador.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/config.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/styles-sadsd@main/home_3/./js/favoritos.js"></script>
